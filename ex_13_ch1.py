...
# Input
principal_amount = float(input("What is the principal_amount amount? "))
...
# Output
if isinstance(principal_amount) and isinstance(interest_rate) and isinstance(years) and isinstance(number_of_periods):
